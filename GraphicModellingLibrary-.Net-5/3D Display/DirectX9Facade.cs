...
namespace GraphicModellingLibrary._3D_Display
{
    ...
    public class DirectX9Facade :/* IObservable<Device>,*/ IDisposable, IFormDisplayer
    {
        ...
        {
            //d3d.Transform.Projection = Matrix.PerspectiveFovLH((float)Math.PI / 4, Width / Height, 1.0f, 20.0f);
